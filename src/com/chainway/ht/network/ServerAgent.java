...
import com.chainway.ht.bean.Result;
...
public class ServerAgent {
	 ...
	 * @throws AppException
	 */
	public static SFileList getFileList(AppContext appContext)
			throws AppException {

		try {
			return SFileList
					.parse(http_get(appContext, URLs.URL_GET_FILE_LIST));
		} catch (Exception e) {
	...
	private static String getUserAgent(AppContext appContext) {
		if (appUserAgent == null || appUserAgent == "") {
			StringBuilder ua = new StringBuilder("raytech.com");
	...
	private static String http_get(AppContext appContext, String url)
		...
		do {
			try {
				...
				Log.i("MY", "http_get statusCode" + statusCode);
				...
				Log.i("MY", "http_get " + responseBody);
